      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 sm:grid-cols-12 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          <div className="lg:col-span-4 md:col-span-6 col-span-6">
            ...
            <p className="text-muted text-opacity-60 text-18 mt-5 max-w-xs">
              CWorks is a full-service digital agency based in Kampala, Uganda. We specialize in web development, UI/UX design, graphic design, database management, and custom software solutions.
            </p>
            <p className="text-muted text-opacity-60 text-17 mt-4">
              Kampala, Uganda | info@cworks.com
            </p>
          </div>
        ...
        <div className="border-t border-[#2a2a3a] py-6 text-center">
          <p className="text-muted text-opacity-60 text-16">
            © 2026 CWorks. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
