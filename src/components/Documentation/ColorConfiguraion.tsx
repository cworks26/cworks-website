      ...
      <div className="p-6 rounded-md border mt-4 border-dark_border border-opacity-60">
        ...
        <div className="py-4 px-5 rounded-md bg-dark_grey mt-8">
          <p className="text-sm text-gray-400 flex flex-col gap-2">
            <span>primary: "#0815A6",</span>
            <span>secondary: "#050F67",</span>
            <span>midnight_text: "#000000",</span>
            <span>muted: "#888888",</span>
            ...
            <span>darkmode: "#000000",</span>
            <span>darklight: "#0a0a1a",</span>
            <span>dark_border: "#2a2a3a",</span>
            <span>tealGreen: "#0815A6",</span>
            <span>charcoalGray: "#666C78",</span>
            <span>deepSlate: "#1E0339",</span>
